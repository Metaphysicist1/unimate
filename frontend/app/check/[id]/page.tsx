    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (isMounted) {
          ...
          console.log(
            "Issues:",
            data?.analysis_results?.issues_found || data?.issues_found,
          );
          if (paid) {
          ...
          <div className="mt-12 pt-8 border-t border-slate-700/50">
            <div className="bg-gradient-to-br from-purple-900/30 to-pink-900/30 border border-purple-500/30 backdrop-blur-sm rounded-xl p-8">
              ...
              <Button
                ...
                disabled={upgrading}
                className="w-full mt-6 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold py-3 rounded-lg transition-all"
              >
